			...
			<div className='Hangman'>
				<nav className='navbar navbar-expand-lg'>
					...
					<div className='collapse navbar-collapse' id='navbarText'>
						...
						<span className='navbar-text text-primary'>Guessed wrong: <span className='red'>{this.state.mistake}</span></span>
					</div>
				</nav>
				<p className='text-center'>
					<img src={this.props.images[this.state.mistake]} alt={altText} />
				</p>
				<p className='text-center text-light'>Guess the Indian State?</p>
